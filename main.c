...
Tuile tuile_restante_test(Tuile plateau[HEIGHT][WIDTH], char cartes[24]) {
    ...
    int nb_lt = 6, nb_tt = 6, nb_l = 10, nb_i = 12, indice = 0;
...
int victoire (Joueur* joueurs, int nb_joueurs) { // parcourt les joueurs et verifie si un joueur a gagne
